      ...
      return (
        <Card sx={{ p: 1, backgroundColor: 'white', border: '1px solid #e0e0e0' }}>
          ...
          <Typography variant="body2" fontWeight="bold">
            {`Usage: ${payload[0].value.toLocaleString()} kWh`}
          </Typography>
        </Card>
      );
    }
...
//         } else {
//           const existing = hourlyMap.get(hourKey);
//           // Calculate usage (difference between latest and first reading)
//           existing.usage = currentValue - existing.value;
...
//           <Typography variant="body2">{`Time: ${label}`}</Typography>
//           <Typography variant="body2" fontWeight="bold">
//             {`Total: ${parseInt(payload[0].value).toLocaleString()} kWh`}
//           </Typography>
//           <Typography variant="body2" color="text.secondary">
//             {`Usage: ${payload[0].payload.usage.toLocaleString()} kWh`}
//           </Typography>
//         </Card>
//       );
//     }
...
//                 size="small"
//               >
//                 <MenuItem value="24h">Current</MenuItem>
//                 <MenuItem value="24h">Last 24 Hours</MenuItem>
//                 <MenuItem value="week">This Week</MenuItem>
//                 <MenuItem value="month">This Month</MenuItem>
//                 <MenuItem value="year">This Year</MenuItem>
